...
private:
	...
	void filename_completions( tokens_t const&, yaal::hcore::HString const&, yaal::hcore::HString const&, FILENAME_COMPLETIONS, completions_t& ) const;
	void user_completions( yaal::tools::HHuginn::value_t const&, tokens_t const&, yaal::hcore::HString const&, yaal::hcore::HString const&, completions_t& ) const;
